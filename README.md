...
[23.12.2025] Parallelized ray tracing using the 'rayon' crate. Support for basic OBJ file loading. Renders the Utah Teapot (6K+ polygons) in ~5 sec on my machine. Currently implements only flat shading for polygons.

![Teapot](https://i.imgur.com/bmoGEmg.png)

[20.12.2025] Experiments with polygons in raytracer (ray/trinalge intersection algorithm generated by GigaCode AI, don't know it yet myself)

![Polygons](https://i.imgur.com/YgNIGrw.png)
